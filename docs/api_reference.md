...
* [catalogv1alpha1.AccountMetadata](#catalogv1alpha1.accountmetadata)
* [catalogv1alpha1.AccountSpec](#catalogv1alpha1.accountspec)
* [catalogv1alpha1.AccountStatus](#catalogv1alpha1.accountstatus)
...
* [operatorv1alpha1.Ferry](#operatorv1alpha1.ferry)
* [operatorv1alpha1.FerryCondition](#operatorv1alpha1.ferrycondition)
* [operatorv1alpha1.FerryList](#operatorv1alpha1.ferrylist)
* [operatorv1alpha1.FerrySpec](#operatorv1alpha1.ferryspec)
* [operatorv1alpha1.FerryStatus](#operatorv1alpha1.ferrystatus)
...
| ----- | ----------- | ------ | -------- |
| metadata |  | [metav1.ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.14/#objectmeta-v1-meta) | false |
| spec |  | [catalogv1alpha1.AccountSpec](#catalogv1alpha1.accountspec) | false |
| status |  | [catalogv1alpha1.AccountStatus](#catalogv1alpha1.accountstatus) | false |

[Back to TOC](#table-of-contents)

## catalogv1alpha1.AccountCondition

AccountCondition contains details for the current condition of this Account.

| Field | Description | Scheme | Required |
| ----- | ----------- | ------ | -------- |
| type | Type is the type of the Account condition, currently ('Ready'). | catalogv1alpha1.AccountConditionType | true |
| status | Status is the status of the condition, one of ('True', 'False', 'Unknown'). | catalogv1alpha1.ConditionStatus | true |
| lastTransitionTime | LastTransitionTime is the last time the condition transits from one status to another. | metav1.Time | true |
| reason | Reason is the (brief) reason for the condition's last transition. | string | true |
| message | Message is the human readable message indicating details about last transition. | string | true |
...
| ----- | ----------- | ------ | -------- |
| metadata |  | [metav1.ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.14/#listmeta-v1-meta) | false |
| items |  | [][catalogv1alpha1.Account](#catalogv1alpha1.account) | true |

[Back to TOC](#table-of-contents)

## catalogv1alpha1.AccountMetadata
...
## catalogv1alpha1.AccountSpec

AccountSpec defines the desired state of Account.

| Field | Description | Scheme | Required |
| ----- | ----------- | ------ | -------- |
| metadata | Metadata\tcontains additional human readable account details | [catalogv1alpha1.AccountMetadata](#catalogv1alpha1.accountmetadata) | false |
| roles | Roles this account uses | []catalogv1alpha1.AccountRole | true |

[Back to TOC](#table-of-contents)

## catalogv1alpha1.AccountStatus
...
| observedGeneration | ObservedGeneration is the most recent generation observed for this Account by the controller. | catalogv1alpha1.int64 | false |
| conditions | Conditions represents the latest available observations of a Account's current state. | [][catalogv1alpha1.AccountCondition](#catalogv1alpha1.accountcondition) | false |
| phase | DEPRECATED. Phase represents the current lifecycle state of this object. Consider this field DEPRECATED, it will be removed as soon as there is a mechanism to map conditions to strings when printing the property. This is only for display purpose, for everything else use conditions. | catalogv1alpha1.AccountPhaseType | false |
...
| ----- | ----------- | ------ | -------- |
| metadata |  | [metav1.ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.14/#objectmeta-v1-meta) | false |
| spec |  | [operatorv1alpha1.FerrySpec](#operatorv1alpha1.ferryspec) | false |
| status |  | [operatorv1alpha1.FerryStatus](#operatorv1alpha1.ferrystatus) | false |

[Back to TOC](#table-of-contents)

## operatorv1alpha1.FerryCondition
...
| type | Type of the condition, currently ('Ready'). | operatorv1alpha1.FerryConditionType | true |

[Back to TOC](#table-of-contents)

## operatorv1alpha1.FerryList
...
| ----- | ----------- | ------ | -------- |
| metadata |  | [metav1.ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.14/#listmeta-v1-meta) | false |
| items |  | [][operatorv1alpha1.Ferry](#operatorv1alpha1.ferry) | true |

[Back to TOC](#table-of-contents)

## operatorv1alpha1.FerrySpec
...
## operatorv1alpha1.FerryStatus

FerryStatus defines the observed state of Ferry

| Field | Description | Scheme | Required |
| ----- | ----------- | ------ | -------- |
| phase | DEPRECATED. Phase represents the current lifecycle state of this object. Consider this field DEPRECATED, it will be removed as soon as there is a mechanism to map conditions to strings when printing the property. This is only for display purpose, for everything else use conditions. | operatorv1alpha1.FerryPhaseType | false |
| conditions | Conditions is a list of all conditions this Ferry is in. | [][operatorv1alpha1.FerryCondition](#operatorv1alpha1.ferrycondition) | false |
