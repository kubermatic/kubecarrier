...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CatapultMappingSpec) DeepCopyInto(out *CatapultMappingSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CatapultMappingSpec.
func (in *CatapultMappingSpec) DeepCopy() *CatapultMappingSpec {
	if in == nil {
		return nil
	}
	out := new(CatapultMappingSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CatapultSpec) DeepCopyInto(out *CatapultSpec) {
	*out = *in
	...
	out.CatapultMappingSpec = in.CatapultMappingSpec
}
