...
// +kubebuilder:webhook:path=/validate-kubecarrier-io-v1alpha1-customresourcedefinitiondiscoveries,mutating=false,failurePolicy=fail,groups=kubecarrier.io,resources=customresourcedefinitiondiscoveries,verbs=update,versions=v1alpha1,name=vcustomresourcedefinitiondiscovery.kubecarrier.io
