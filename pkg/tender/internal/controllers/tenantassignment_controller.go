...
// +kubebuilder:rbac:groups=core.kubecarrier.io,resources=tenantassignments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.kubecarrier.io,resources=tenantassignments/status,verbs=get;update;patch
