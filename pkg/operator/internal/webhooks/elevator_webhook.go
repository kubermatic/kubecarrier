...
var _ admission.Handler = (*ElevatorWebhookHandler)(nil)

// +kubebuilder:webhook:path=/mutate-operator-kubecarrier-io-v1alpha1-elevator,mutating=true,failurePolicy=fail,groups=operator.kubecarrier.io,resources=elevators,verbs=create,versions=v1alpha1,name=melevator.kubecarrier.io
...
// ElevatorWebhookHandler implements admission.DecoderInjector.
