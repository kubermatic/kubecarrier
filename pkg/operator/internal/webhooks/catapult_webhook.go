...
// +kubebuilder:webhook:path=/mutate-operator-kubecarrier-io-v1alpha1-catapult,mutating=true,failurePolicy=fail,groups=operator.kubecarrier.io,resources=catapults,verbs=create,versions=v1alpha1,name=mcatapult.kubecarrier.io
...
// CatapultWebhookHandler implements admission.DecoderInjector.
