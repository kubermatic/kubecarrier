...
func request_Doc_SwaggerStatic_0(ctx context.Context, marshaler runtime.Marshaler, client DocClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.SwaggerStatic(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Doc_SwaggerStatic_0(ctx context.Context, marshaler runtime.Marshaler, server DocServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DocStaticRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SwaggerStatic(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterDocHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DocServer) error {
	...
	mux.Handle("GET", pattern_Doc_SwaggerStatic_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Doc_SwaggerStatic_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Doc_SwaggerStatic_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDocHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DocClient) error {
	...
	mux.Handle("GET", pattern_Doc_SwaggerStatic_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Doc_SwaggerStatic_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Doc_Swagger_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "swagger"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Doc_SwaggerStatic_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "swagger", "path"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_Doc_SwaggerStatic_0 = runtime.ForwardResponseMessage
)
