...
# yq -Y  '. + {"aggregationRule": {"clusterRoleSelectors": [{"matchLabels": {"kubecarrier.io/manager": "true"}}]}}' "config/internal/manager/rbac/role.yaml" > ${out} && mv ${out} "config/internal/manager/rbac/role.yaml"
